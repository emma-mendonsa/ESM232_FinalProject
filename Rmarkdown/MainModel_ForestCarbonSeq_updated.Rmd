...
combined = data.frame(year = 2010:2100, 
                      ...
                      p_p1 = rep(p1, years), 
                      p_p2 = rep(p2, years),
                      p_p3 = rep(p3, years), # No Beetle impact (in for loop). When impacted by beetles, this value decreases as beetles increase.
                      p_p4 = rep(p4, years), # No Beetle impact (in for loop) 
...
combined[1,20] = initial_carbon # Initial carbon contained in the whitepine pop.
combined[1,21] = ifelse(clim_BAU$Su_tmax[1] >36 && clim_BAU$W_tmin[1] > 2, "H", "L") # Initial probability of fire
combined[1,22] = ifelse(clim_BAU$apr_snow[1] >=80, "Low", ifelse(clim_BAU$apr_snow[1] >=60, "Mod", "Sev")) # Initial severity of fire

for(i in 2:years){
  
################################################# Beetles ######################

  tmp = data.frame(time = 1:time) # Temporary data.frame for beetle output. 
