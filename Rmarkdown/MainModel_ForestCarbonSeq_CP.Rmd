...
for(i in 2:nrow(beetles)){
  ...
  beetles[i,5] = beetles$climate_coeff[i]*beetle_pop(beetles$pop[i-1],r=beetles$r_max[i],K=K)
}
...
# Combining beetle and pine
```{r}
years = 91
combined = data.frame(year = 2010:2100,
                      btl_r_coef = round(seq(from=1,to = 1.5,length.out=91),2),
                      btl_r = round(r_0*combined$btl_r_coef,2),
                      btl_pop = rep(0,91),
                      p_p0 = seq(from = p0, to=0.5, length.out = 91),
                      p_p1 = seq(from = p1, to = 0.5, length.out = 91),
                      p_p2 = seq(from = p2, to = 0.5,length.out = 91),
                      p_p3 = seq(from = p3, to = 0.5, length.out = 91),
                      p_p4 = seq(from = p4, to = 0.5, length.out = 91),
                      g01 = seq(from = g01, to = g01/2, length.out = 91),
                      g12 = seq(from = g12,to = g12/2, length.out = 91),
                      g23 = seq(from = g23, to = g23/2, length.out = 91),
                      g34 = seq(from = g34, to = g34/2, length.out = 91),
                      pine0 = rep(0,91),
                      pine1 = rep(0,91),
                      pine2 = rep(0,91),
                      pine3 = rep(0,91),
