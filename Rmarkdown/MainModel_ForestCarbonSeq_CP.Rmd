...
combined[1,24] = 0 # Inital burnt biomass
combined[1,25] = 256876 # Initial carbon = post-fire cabon b/c no fire occurred yet
...
combined$fire_occurs[i] = ifelse(combined$fire_prob[i] == "H" && combined$fire_sev[i] == "Mod" |combined$fire_sev[i] == "Sev", "Y", "N")
